#!/system/bin/sh
if ! applypatch --check EMMC:/dev/block/platform/bootdevice/by-name/recovery$(getprop ro.boot.slot_suffix):50331648:c6fa8ca0ffb5242b6c304929ce876b84cb60f1d8; then
  applypatch \
          --patch /system/recovery-from-boot.p \
          --source EMMC:/dev/block/platform/bootdevice/by-name/boot$(getprop ro.boot.slot_suffix):33554432:795e70bffb748d808b8486a6c1c5c3433993ffcd \
          --target EMMC:/dev/block/platform/bootdevice/by-name/recovery$(getprop ro.boot.slot_suffix):50331648:c6fa8ca0ffb5242b6c304929ce876b84cb60f1d8 && \
